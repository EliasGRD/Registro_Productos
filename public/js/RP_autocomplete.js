...
"use strict";
/*!*****************************************!*\
  !*** ./resources/js/RP_autocomplete.js ***!
  \*****************************************/
      ...
      success: function success(respuesta) {
        if (respuesta) {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#alertD").hide();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#alertD").fadeTo(2000, 500).slideUp(500, function () {
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#alertD").slideUp(500);
            });
            ...
            function _demo() {
              _demo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
window.autocompletar = function autocompletar(id) {
  ...
  var Selector = document.getElementById("Acciones_" + input_id);
  var div2 = document.getElementById("div2_" + input_id);
  jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
    type: 'GET',
    url: "/regpro/search",
    dataType: 'html',
